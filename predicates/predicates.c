...
// *** C. Oberdorfer added this here
// *** (see Shewchuks web-page for details)
...
void exactinit()
{
  ...
  // *** C. Oberdorfer added these lines
...
#ifdef SINGLE
	REAL orient2d_single(pa, pb, pc)
#else
	REAL orient2d_double(pa, pb, pc)
#endif
REAL *pa;
REAL *pb;
REAL *pc;
...
#ifdef SINGLE
	REAL orient3d_single(pa, pb, pc, pd)
#else
	REAL orient3d_double(pa, pb, pc, pd)
#endif
REAL *pa;
REAL *pb;
REAL *pc;
...
#ifdef SINGLE
	REAL incircle_single(pa, pb, pc, pd)
#else
	REAL incircle_double(pa, pb, pc, pd)
#endif
REAL *pa;
REAL *pb;
REAL *pc;
...
#ifdef SINGLE
	REAL insphere_single(pa, pb, pc, pd, pe)
#else
	REAL insphere_double(pa, pb, pc, pd, pe)
#endif
REAL *pa;
REAL *pb;
REAL *pc;
